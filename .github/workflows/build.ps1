...
Info "Run tests"
python $root/src/test.py -v
CheckReturnCodeOfPreviousCommand "Running tests failed"

CopyFile $root/src/add_license_header.py $root/build
InsertVersionInsideScript $root/build/add_license_header.py $version
CreateZipArchive $root/build/add_license_header.py $root/build/$projectName
